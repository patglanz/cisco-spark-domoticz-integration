...
#This bash script will list the details on all cisco spark rooms you're a member of, including the room IDs (Which you will need in order to run sparkmessage.sh) 
